...
public class GrainProcessingPlantSpecification extends BuildingSpecification {

	public GrainProcessingPlantSpecification() {
		super(BuildingType.IND_SMALL, ZoneType.INDUSTRIAL);
		productForSale.setMaxQuantityForProduct(Product.PROCESSED_FOOD, 10);
		productForSale.setQuantityForProduct(Product.PROCESSED_FOOD, 0);
	}
